<x-app-layout>
    ...
    <div class="py-12 max-w-7xl mx-auto px-4">
        ...
        <div class="bg-white shadow rounded-lg p-6 border-l-4 border-teletalk-green mb-8">
            <h3 class="font-bold text-lg mb-4 text-gray-800">Scan or Search File</h3>
            <div class="flex items-center space-x-2">
                <input type="text" id="omni-search" placeholder="Scan Barcode or Enter Tracking ID..." class="w-full text-xl p-4 border-2 border-gray-300 rounded focus:border-teletalk-green">
